  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <!-- NEW -->
        % if conflict == 7:
          <p>Вы уже зарезервированы на эту игру</p>
        % end
        % if conflict == 8:
          <p>В этой игре нет резервных мест!</p>
        % end
        % if conflict == 9:
          <p>Все резервные места заняты</p>
        % end
        % if conflict == 10:
          <p>Вы не можете записаться в резерв так как есть свободные места в этой игре</p>
        % end
        % if conflict == 10:
