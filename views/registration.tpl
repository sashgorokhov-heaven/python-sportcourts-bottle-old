  ...
  <div class="row">
    ...
    <form id="registrationForm" method="post" class="form-horizontal" action="/registration"
        ...
        <div class="form-group">
          ...
          <div class="col-sm-10">
            <input type="text" class="form-control" name="phone" placeholder="" id="phone" value="+7" data-toggle="tooltip" data-placement="bottom" title="Телефон необходим для координаторов игр" data-bv-notempty="true" data-bv-notempty-message="Укажите телефон" ></input>
            <span id="valid"></span>
          </div>
        </div>
