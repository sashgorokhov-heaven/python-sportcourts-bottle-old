      ...
      <div class="modal-body">
        ...
        <form id="loginForm" method="post" class="form-horizontal" autocomplete="on" action="/auth">
          <div class="form-group" id="passwd">
            ...
            <div class="col-sm-10">
              <a href="https://oauth.vk.com/authorize?client_id=4436558&scope=&redirect_uri=http://{{serverinfo['ip']}}:{{serverinfo['port']}}/auth&response_type=code&v=5.21">
      ...
      <div class="modal-body text-center">
        ...
        <div class="input-group" style="min-width:498px; margin: 0 auto;">
          <form action="" style="text-align: center">
            <input type="text" id="email2" class="form-control input-lg" placeholder="Введи свой email" style="max-width:320px;">
            <span class="input-group-btn">
              <button id="email2button" class="btn btn-main btn-lg btn-success" type="submit">Присоединиться</button>
            </span>
          </form>
          <br>
          <br>
...
% if loggedin and tplname!='index' and tplname!='2015' and tplname!='referal':
